...
public class Main {
    public static void main(String[] args) {
        ...
        LocalDate diaFuturo = LocalDate.parse("2022-11-30");
        System.out.println("Data futura: " + diaFuturo);
        LocalDate diaPresente = LocalDate.now();
        System.out.println("Data presente: " + diaPresente);

        Duration duracao = Duration.between(diaPresente.atStartOfDay(), diaFuturo.atStartOfDay()
        );
